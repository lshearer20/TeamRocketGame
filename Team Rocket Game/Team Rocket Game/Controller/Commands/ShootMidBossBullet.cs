...
{
    public class ShootMidBossBullet : Shoot
    {
        // Fields
        ...
        // Constructor
        public ShootMidBossBullet(GameData gameData)
        {
            this.myReciever = gameData.MidBossBulletFact;
        ...
        public override void execute()
        {
            ...
            //Add bullet to enemy bullet list
